...
#define CUSTOM_SHOW_USB_PROGRESS
#define CUSTOM_SHOW_FATLOAD_PROGRESS
...
#define CFG_SE_PHYSICAL_BASE	0x70000000	/* LMI Physical Address */
...
#define CFG_MEMTEST_END		(CFG_SDRAM_BASE + 0x08000000 - (3 << 20) )
...
#define CONFIG_EXTRA_ENV_SETTINGS \
		"board=" XSTR(BOARD) "\0" \
		"monitor_file_name=" "u-boot.bin" "\0" \
		"load_addr=" XSTR(CFG_LOAD_ADDR) "\0" \
    "autostart=yes" "\0" \
    "silent=1" "\0" \
    "resetenv=" "eeprom write $load_addr " XSTR(CFG_MONITOR_LEN) " 1000" "\0" \
		"updatefw=" \
          "usb start;" \
          "set filesize;" \
          "fatload usb 0 $load_addr idl4k.scr;" \
          "if test \"${filesize}\" != \"\"; then autoscr $load_addr; fi \0" \
	    "bootcmd=" "run updatefw; nboot.jffs2 $load_addr fw1-nand0;" "\0" \
	    "bootargs=" "" "\0" \
...
#define CFG_PROMPT		"idl4k> "	/* Monitor Command Prompt	*/
#define CFG_PROMPT_HUSH_PS2	"> "
#define CFG_CBSIZE		1024
#define CFG_PBSIZE (CFG_CBSIZE+sizeof(CFG_PROMPT)+16) /* Print Buffer Size	*/
#define CFG_MAXARGS		16		/* max number of command args	*/
#define CFG_HZ			1000		/* HZ for timer ticks	*/
#define CFG_LOAD_ADDR		0x84000000	/* default load address		*/
...
#define MTDPARTS_NOR						\
	"physmap-flash:"	/* First NOR flash device */		\
		"512k(U-Boot)"		/* first partition */		\
		",128k(Environment)"					\
		",-(Firmware)"	/* last partition */
#define MTDIDS_NOR						\
...
#undef CFG_NAND_ECC_AFM4		/* define for AFM4 (4+3/512) ECC compatibility */
	 ...
	 */
#define CFG_NAND_STM_BOOT_MODE_BOUNDARY (0)	/* 0 MiB */
...
#define CONFIG_SPI_FLASH_MXIC		/* MX25L8006E */
