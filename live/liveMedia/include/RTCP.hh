...
public:
  ...
  typedef unsigned int AppPacketFunc(void* clientData, unsigned char const**);
  ...
  void setAppPacketHandler(AppPacketFunc* appPacketHandler, void* handlerClientData) {
    if (fAppPacketHandler == NULL || appPacketHandler == NULL) {
      fAppPacketHandler = appPacketHandler;
      fAppPacketHandlerClientData = handlerClientData;
    }
  }
...
private:
  ...
  AppPacketFunc* fAppPacketHandler;
  void* fAppPacketHandlerClientData;
