...
public:
  ...
  void addDestination(struct in_addr const& addr, Port const& port, bool igmpReq = false, bool ownerSession = true);
  void removeDestination(struct in_addr const& addr, Port const& port, bool igmpReq = false, bool ownerSession = true);
